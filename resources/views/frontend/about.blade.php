            ...
            <div class="row no-gutters">
                <div class="col-md-4">
                    ...
                    <div class="transport-item wow fadeInUp" data-wow-delay="0.25s">
                        ...
                        <div class="icon-box">
                            <img src="{{asset('assets/images/icon-transport-1.svg')}}" alt="">
                        </div>
                        <!-- Transport Icon End -->
                ...
                <div class="col-md-4">
                    ...
                    <div class="transport-item wow fadeInUp" data-wow-delay="0.5s">
                        <!-- Transport Icon Start -->
                        <div class="icon-box">
                            <img src="{{asset('assets/images/icon-transport-2.svg')}}" alt="">
                        </div>
                        <!-- Transport Icon End -->
                ...
                <div class="col-md-4">
                    ...
                    <div class="transport-item wow fadeInUp" data-wow-delay="0.75s">
                        <!-- Transport Icon Start -->
                        <div class="icon-box">
                            <img src="{{asset('assets/images/icon-transport-3.svg')}}" alt="">
                        </div>
                        <!-- Transport Icon End -->
    ...
    <div class="export-team">
        <div class="container">
            <div class="row">
                <!-- Section Title Start -->
                <div class="section-title">
                    <h2 class="text-anime-style-3">Transport<span> expert team</span></h2>
