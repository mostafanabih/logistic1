                        ...
                        <div class="get-quote-form wow fadeInUp" data-wow-delay="0.75s">
                            <form id="contactForm" action="#" method="post" data-toggle="validator">
                                <div class="row">
                                    ...
                                    <div class="form-group  col-md-12 mb-3">
                                        <input type="email" class="form-control" id="email" placeholder="البريد الكتروني" required="">
                                        <div class="help-block with-errors"></div>
                                    </div>

                                    <div class="form-group col-md-12 mb-3">
                                        <textarea name="msg" class="form-control" id="msg" rows="3" placeholder="الرساله" required=""></textarea>
                                        <div class="help-block with-errors"></div>
                                    </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="google-map-iframe">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d14516.019250769436!2d46.5941501!3d24.5544958!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e2f111aede8f4ed%3A0xbb9d460e166cc220!2z2LTYsdmD2Kkg2KrZhdmK2LIg2KfZhNmG2KzYp9itINin2YTZhNmI2KzYs9iq2YrYqQ!5e0!3m2!1sen!2ssa!4v1721498698175!5m2!1sen!2ssa" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>                    </div>
                </div>
            </div>
        </div>
    </div>
